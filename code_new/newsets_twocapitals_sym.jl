...
filename = Nothing
#function twocapitals(symmetric_returns = 0, state_dependent_xi = 2, compute_irfs = 0, kappa_tilde = .005, beta2_hat = 0.5, filename_new = nothing)
#==============================================================================#
# SPECIFICATION:
#==============================================================================#
...
kappa_tilde = parse(Float64, ARGS[5])
beta2_hat = parse(Float64, ARGS[6])
filename_new = ARGS[7]
println(filename_new)
# symmetric_returns    = 0
...
if filename_new === nothing
    filename_new = filename
end
npzwrite( filename_new, results)


# for ite in [0.003,0.004,0.005,0.006,0.007,0.008]
#     println("beta = ", ite)
#     s = string("model_sym_HSHS" , replace(string(ite),"."=>""))
#     twocapitals(1,1,0,ite,0.5,s)
# # end
